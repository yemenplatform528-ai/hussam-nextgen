...
| Yemen Payments & Clearing Company (YPCC) | payment infrastructure | Central Bank reports establishment/infrastructure role | Central Bank of Yemen | `discovered` | Hussam participation/connection model, technical interface, eligibility, certification |
| WeNet | national payment infrastructure | official site documents interbank/inter-wallet connectivity and instant transfers, including person-to-merchant payments | WeNet official site | `public_capability_evidence` | Hussam eligibility/connection model, technical interface, credentials, certification |
| Yemen Wallet | electronic wallet | official site documents bank/wallet transfers, local remittance-network transfers, merchant/service payments and cash-out | Yemen Wallet official site | `public_capability_evidence` | licensing evidence, merchant integration path, API/spec, credentials, settlement/reconciliation certification |
| Al-Najm / AnnajmPlus | financial/remittance provider | official site documents money transfer/receipt, FX buy/sell, 2,000+ agents and nationwide coverage claims | Official AnnajmPlus site | `public_capability_evidence` | licensing evidence, market scope, contract/API or approved operating path, settlement/reconciliation certification |
