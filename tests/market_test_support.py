...
def ensure_market(db, code='YE', country_code='YE', currency='YER'):
    market=MarketContext(code=code,country_code=country_code,name='Test Market',locale='ar-YE',timezone='Asia/Aden',default_currency=currency,status='active')
